...
#     else
#         DOWNLOAD_LINK="https://www.280i.com/file/V2ray/v2ray-linux-64.zip"
#     fi

    DOWNLOAD_LINK="https://github.com/v2ray/v2ray-core/releases/download/v4.27.0/v2ray-linux-64.zip"
